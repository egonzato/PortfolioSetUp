  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      <div className="container max-w-4xl mx-auto px-6 md:px-4 relative z-10">
        ...
        >
          <div className="text-center md:text-left">
            ...
            <div className="relative">
              ...
              <img
                src="/PortfolioSetUp//profile.png"
                alt="Profile"
        ...
        <MotionWrapper>
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm backdrop-filter p-4 rounded-lg border border-purple-500/20 shadow-sm">
            <p className="text-muted-foreground pl-4 py-2 mb-4 relative">
              <span className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-green-500 to-green-500 rounded-full"></span>
